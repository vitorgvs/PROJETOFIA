...
with DAG(
        ...
        start_date=datetime(2025, 8, 1),  # A data em que o DAG deve começar a funcionar pela primeira vez
        end_date=datetime(2025, 8, 6),  # A data em que o DAG deve encerrar o funcionamento
